extends Resource
class_name CharacterStatResource

@export var strengthStat: float = 5.0
@export var agilityStat: float = 5.0
@export var enduranceStat: float = 5.0
@export var intelligenceStat: float = 5.0
@export var wisdomStat: float = 5.0
@export var charismaStat: float = 5.0
@export var perceptionStat: float = 5.0
@export var accuracyStat: float = 5.0
@export var willpowerStat: float = 5.0
@export var luckStat: float = 5.0
